...
-- Safe version for Supabase SQL Editor
...
ALTER TABLE search_view ENABLE ROW LEVEL SECURITY;

-- Create RLS policy for the search view
CREATE POLICY "Users can view their own searches" ON search_view
    FOR SELECT
