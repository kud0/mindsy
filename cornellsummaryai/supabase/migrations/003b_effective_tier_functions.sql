-- Migration: Create effective subscription tier functions
-- This migration assumes 003a_drop_old_function.sql has been run first
...
-- 2. Create new check_usage_limits function with enhanced return type
...
-- 6. Add index for better performance on subscription period queries
