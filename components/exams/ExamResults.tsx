  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      ...
      <Card className={cn(
        ...
        isPassing ? "bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900 dark:to-emerald-900" : "bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900 dark:to-orange-900"
      )}>
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      question.isCorrect ? "border-green-200 bg-green-50/50 dark:border-green-800 dark:bg-green-900/20" : "border-red-200 bg-red-50/50 dark:border-red-800 dark:bg-red-900/20"
                    )}
                  >
                    <div 
                            ...
                            return (
                              <div
                                ...
                                className={cn(
                                  ...
                                  isCorrectAnswer && "bg-green-100 border border-green-300 dark:bg-green-800 dark:border-green-600",
                                  isUserAnswer && !isCorrectAnswer && "bg-red-100 border border-red-300 dark:bg-red-800 dark:border-red-600",
                                  !isUserAnswer && !isCorrectAnswer && "bg-muted"
                                )}
                              >
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <Badge 
                          ...
                          className={cn(
                            performanceLevel === 'excellent' && "bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100",
                            performanceLevel === 'good' && "bg-blue-100 text-blue-800 dark:bg-blue-800 dark:text-blue-100",
                            performanceLevel === 'needs-practice' && "bg-yellow-100 text-yellow-800 dark:bg-yellow-800 dark:text-yellow-100",
                            performanceLevel === 'weak' && "bg-red-100 text-red-800 dark:bg-red-800 dark:text-red-100"
                          )}
                        >
