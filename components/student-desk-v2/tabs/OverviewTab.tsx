    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      {overview.mainTopic && (
        <div className="space-y-3">
          ...
          <p className="text-gray-700 leading-relaxed pl-7">{overview.mainTopic}</p>
        </div>
      )}
      ...
      {explanations && explanations.length > 0 && (
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-semibold text-gray-900">Class Outline</h2>
          </div>
          <div className="space-y-3 pl-7">
            {explanations.map((explanation, index) => (
              <div key={explanation.id} className="space-y-1">
                <div className="flex items-start gap-3">
                  <span className="flex-shrink-0 text-sm font-medium text-gray-500 mt-0.5">
                    {index + 1}.
                  </span>
